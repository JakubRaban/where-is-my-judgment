...
public class JudgmentJSONParser {
    ...
    private boolean isJSONFile(String json) {
        return json.contains("items") && json.contains("queryTemplate");
    }
    ...
    private String dropMetadata(String parsedJson) throws ParseException {
        ...
        if(start == -1 || end == -1) throw new ParseException("The file is not a proper judgment JSON", 0);
